...
@pytest.mark.xfail(strict=True, reason="Negative numbers are not supported")
def test_negative_numbers():
    print_number_list([-1, -2, -3, -4, -5])

@pytest.mark.xfail(strict=True, reason="Numbers larger than u64::MAX are not supported")
