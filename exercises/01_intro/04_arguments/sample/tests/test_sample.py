...
@pytest.mark.fail(reason="Negative numbers are not supported", raises=OverflowError)
def test_negative_numbers():
    print_number_list([-1, -2, -3, -4, -5])

@pytest.mark.fail(reason="Numbers larger than u64::MAX are not supported", raises=OverflowError)
